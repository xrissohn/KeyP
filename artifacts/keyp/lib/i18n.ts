...
export const STRINGS: Record<string, Record<Language, string>> = {
  ...
  'sourceShort.facebook': { ko: 'FB', en: 'FB' },
  'sourceShort.instagram': { ko: 'IG', en: 'IG' },
  'sourceShort.tiktok': { ko: 'TT', en: 'TT' },
  'sourceShort.threads': { ko: 'TH', en: 'TH' },
  'sourceShort.bluesky': { ko: 'BS', en: 'BS' },
  'sourceShort.mastodon': { ko: 'MA', en: 'MA' },
  'sourceShort.naver_blog': { ko: 'NB', en: 'NB' },
  'sourceShort.hackernews': { ko: 'HN', en: 'HN' },
  'sourceShort.news': { ko: '뉴스', en: 'News' },
  ...
  'source.facebook': { ko: 'Facebook', en: 'Facebook' },
  'source.instagram': { ko: 'Instagram', en: 'Instagram' },
  'source.tiktok': { ko: 'TikTok', en: 'TikTok' },
  'source.threads': { ko: 'Threads', en: 'Threads' },
  'source.bluesky': { ko: 'Bluesky', en: 'Bluesky' },
  'source.mastodon': { ko: 'Mastodon', en: 'Mastodon' },
  'source.naver_blog': { ko: '네이버 블로그', en: 'Naver Blog' },
  'source.hackernews': { ko: 'Hacker News', en: 'Hacker News' },
  'source.news': { ko: '뉴스', en: 'News' },
  ...
  'alert.hidden.toast': { ko: '알림을 숨겼어요', en: 'Alert hidden' },
  'alert.undo': { ko: '되돌리기', en: 'Undo' },
  'common.search': { ko: '검색', en: 'Search' },
  'common.clear': { ko: '지우기', en: 'Clear' },
  'saved.searchPlaceholder': { ko: '저장한 알림 검색…', en: 'Search saved alerts…' },
  'saved.noResults': { ko: '검색 결과가 없어요', en: 'No matches found' },
  'saved.noResultsSub': { ko: '"{q}"에 해당하는 저장 알림이 없습니다', en: 'No saved alerts match "{q}"' },
  ...
  'sourceLabel.facebook': { ko: 'Facebook', en: 'Facebook' },
  'sourceLabel.instagram': { ko: 'Instagram', en: 'Instagram' },
  'sourceLabel.tiktok': { ko: 'TikTok', en: 'TikTok' },
  'sourceLabel.threads': { ko: 'Threads', en: 'Threads' },
  'sourceLabel.bluesky': { ko: 'Bluesky', en: 'Bluesky' },
  'sourceLabel.mastodon': { ko: 'Mastodon', en: 'Mastodon' },
  'sourceLabel.naver_blog': { ko: '네이버 블로그', en: 'Naver Blog' },
  'sourceLabel.hackernews': { ko: 'Hacker News', en: 'Hacker News' },
  'sourceLabel.news': { ko: '뉴스', en: 'News' },
  ...
  'auth.forgot.body': {
    ko: '데모 앱입니다. 아래 버튼으로 안전하게 체험할 수 있어요.',
    en: 'Demo app — use the button below for a safe preview.',
  },

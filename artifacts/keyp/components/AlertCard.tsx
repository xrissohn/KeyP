...
const SOURCE_ICONS: Record<SourceType, { name: keyof typeof Feather.glyphMap; color: string }> = {
  ...
  tiktok: { name: 'music', color: '#00D4C7' },
  threads: { name: 'at-sign', color: '#8B8B8B' },
  bluesky: { name: 'cloud', color: '#1185FE' },
  mastodon: { name: 'message-square', color: '#6364FF' },
  naver_blog: { name: 'book-open', color: '#03C75A' },
  hackernews: { name: 'code', color: '#FF6600' },
  news: { name: 'file-text', color: '#5B7FFF' },
